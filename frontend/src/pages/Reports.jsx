...
// ─── Markdown components (same as Agent.jsx) ───
const markdownComponents = {
    ...
    code: ({ inline, children }) =>
        inline ? (
            <code style={{ background: 'rgba(255,255,255,0.08)', padding: '2px 6px', borderRadius: 4, fontSize: 12, color: '#4F8EF7' }}>{children}</code>
        ) : (
            <pre style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 8, padding: 12, overflowX: 'auto', fontSize: 12, color: 'rgba(255,255,255,0.7)' }}>
                <code>{children}</code>
            </pre>
        ),
};
