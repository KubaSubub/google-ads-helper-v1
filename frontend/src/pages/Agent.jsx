...
const QUICK_ACTIONS = [
    {
        ...
        icon: FileText,
        reportType: 'weekly',
        message: 'Przygotuj raport tygodniowy z KPI, zmianami tydzien do tygodnia, aktywnymi alertami i top rekomendacjami.',
    },
    {
        label: 'Analiza kampanii',
        icon: Megaphone,
        reportType: 'campaigns',
        message: 'Przeanalizuj wszystkie aktywne kampanie. Porownaj wyniki, zidentyfikuj najlepsze i najgorsze, sprawdz pacing budzetow.',
    },
    {
        label: 'Analiza budzetow',
        icon: Wallet,
        reportType: 'budget',
        message: 'Sprawdz pacing budzetow i zidentyfikuj zmarnowane wydatki. Zaproponuj realokacje.',
    },
    {
        label: 'Wyszukiwane frazy',
        icon: Search,
        reportType: 'search_terms',
        message: 'Przeanalizuj wyszukiwane frazy. Znajdz frazy marnujace budzet, zaproponuj wykluczenia.',
    },
    {
        label: 'Slowa kluczowe',
        icon: KeyRound,
        reportType: 'keywords',
        message: 'Przeanalizuj wydajnosc slow kluczowych. Znajdz slowa z niskim Quality Score, wysokim kosztem bez konwersji.',
    },
    {
        label: 'Alerty i anomalie',
        icon: AlertTriangle,
        reportType: 'alerts',
        message: 'Podsumuj aktywne alerty i anomalie. Wyjasniej kazdy problem, zaproponuj dzialania naprawcze.',
    },
];
...
const markdownComponents = {
    ...
    h1: ({ children }) => (
        <h1 style={{ fontSize: 20, fontWeight: 700, fontFamily: 'Syne', color: '#fff', margin: '16px 0 8px' }}>{children}</h1>
    ),
    h2: ({ children }) => (
        <h2 style={{ fontSize: 16, fontWeight: 600, fontFamily: 'Syne', color: '#fff', margin: '14px 0 6px' }}>{children}</h2>
    ),
    h3: ({ children }) => (
        <h3 style={{ fontSize: 14, fontWeight: 600, color: 'rgba(255,255,255,0.85)', margin: '12px 0 4px' }}>{children}</h3>
    ),
    p: ({ children }) => (
        <p style={{ color: 'rgba(255,255,255,0.7)', lineHeight: 1.6, margin: '6px 0' }}>{children}</p>
    ),
    li: ({ children }) => (
        <li style={{ color: 'rgba(255,255,255,0.7)', lineHeight: 1.6, marginBottom: 2 }}>{children}</li>
    ),
