    ...
    const Row = ({ c, type }) => {
        ...
        return (
            ...
            >
                ...
                <span style={{ fontSize: 12, fontWeight: 600, fontFamily: 'Syne', color, flexShrink: 0 }}>
                    {c.roas.toFixed(2)}x
                </span>
                <span style={{ fontSize: 11, color: 'rgba(255,255,255,0.35)', flexShrink: 0, minWidth: 60, textAlign: 'right' }}>
                    {c.cost.toFixed(0)} zl
                </span>
            </div>
        )
